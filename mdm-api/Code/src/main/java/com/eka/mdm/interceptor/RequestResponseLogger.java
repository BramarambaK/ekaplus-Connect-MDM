...
public class RequestResponseLogger {
	...
	@AfterReturning("execution(* com.eka.mdm..controller..* (..))")
	...
	@AfterReturning(value = "execution(* com.eka.mdm..controller..* (..))", returning = "result")
	...
	@AfterThrowing(value = "execution(* com.eka.mdm..controller..* (..))", throwing = "e")
	public void afterThrowing(JoinPoint joinPoint, Throwable e) {
		if(contextProvider.getCurrentContext().getRequest()!=null)
